...
{
    public partial class EntityModuleCentrum : System.Web.UI.UserControl
    {
        ...
        protected void ddlCategoryName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                if (boolDisplayFolder == true)
                {
                    objUtility.Result = Utility.LoadFolder_Centrum(tvwFolder, Convert.ToInt32(ddlMetaTemplateName.SelectedItem.Value),Convert.ToInt32(ddlCategoryName.SelectedItem.Value));
