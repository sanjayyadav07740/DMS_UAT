<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EntityModule.ascx.cs"
    Inherits="DMS.UserControl.EntityModule" %>
    ...
    <ContentTemplate>
        <table>
            ...
            <tr>
                ...
                <td align="left">
                    <asp:Panel ID="panFolder" runat="server" Width="400px" Height="200px">
            ...
            <tr id="trmetadata" runat="server" visible="false">
                <td align="left" valign="top">
