<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocumentViewer.ascx.cs" Inherits="DMS.UserControl.DocumentViewer" %>
            ...
            <tr>
                <td colspan="2" style="width: 600px;" valign="top" align="center" class="viewerToolBar">
                    <div id="divSave" runat="server" visible="false">
                        <img src="../UserControl/Image/download-btn.png" style="width: 100px;" onclick="javascript:downloadFile();" class="toolBarIcon" title="Save File"/>
                        <br />
                            </div>
                    <br />
...
<%--                        <asp:ImageButton ID="ibtnSave" runat="server" ImageUrl="../UserControl/Image/Save.png" OnClientClick="javascript:downloadFile();" Width="20px" Height="20px" OnClick="ibtnSave_Click"  />--%>
            ...
            <tr>
                <td colspan="2"  valign="top" align="center" class="viewer">
                    ...
                    <%--<div id="divPrintScr" style="display: block; width: 600px; height: 600px; z-index: 100;
                            position: absolute; background-color:darkgrey; opacity: 1; filter: alpha(opacity=30);" class="viewer">
                       <div id="content"><h2>Please Keep Mouse Curosr Inside Viewer</h2></div>
                               </div>--%>
                </td>
            </tr>
            <tr>
            ...
            <td colspan="2" align="center">
                <asp:ImageButton ID="ibtnApprove" runat="server"  CausesValidation="false"  SkinID="ApproveButton"                        
                    ToolTip='Click Here To Approve This Page.' OnClick="ibtnApprove_Click" Visible="false" />
               
                &nbsp;
                 <asp:ImageButton ID="ibtnReject" runat="server"  CausesValidation="false"  SkinID="RejectButton"                        
                    ToolTip='Click Here To Reject This Page.'  OnClick="ibtnReject_Click" Visible="false"/>
                &nbsp;
                <asp:ImageButton ID="ImageButton1" runat="server"  CausesValidation="false"  SkinID="CancelButton"
                    ToolTip='<%$ Resources:Resource,Back %>' onclick="ibtnBack_Click" Visible="true" />
                    &nbsp;
