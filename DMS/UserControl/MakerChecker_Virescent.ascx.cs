...
{
    public partial class MakerChecker_Virescent : System.Web.UI.UserControl
    {
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (ViewType == ViewMakerCheckerFor.DocumentEntry || ViewType == ViewMakerCheckerFor.DocumentVerification)
                        BusinessLogic.Utility.GenerateControlAndFillData_Virescent(e, gvwDocument, hdfField, ref byteFileByte, UserSession.Document, UserSession.Field, UserSession.List, BusinessLogic.Utility.EnableOrDisable.Enable);
                    else
                        BusinessLogic.Utility.GenerateControlAndFillData_Virescent(e, gvwDocument, hdfField, ref byteFileByte, UserSession.Document, UserSession.Field, UserSession.List, BusinessLogic.Utility.EnableOrDisable.Disable);
