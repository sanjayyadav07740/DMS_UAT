<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" AutoEventWireup="true" CodeBehind="UserAccessRights.aspx.cs" Inherits="DMS.User.UserAccessRights" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <center>
        <asp:Label ID="lblTitle" runat="server" Text="User Access Rights" SkinID="Title"></asp:Label>
    </center>
    <table border="0" cellpadding="0" cellspacing="0" width="931">
        ...
        <tr>
            <td align="2">
                <asp:TreeView ID="tvwUserAccessRights" ShowCheckBoxes="All" runat="server" EnableTheming="false"
