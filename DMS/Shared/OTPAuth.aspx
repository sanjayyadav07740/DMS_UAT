<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OTPAuth.aspx.cs" Inherits="DMS.Shared.OTPAuth" %>
                ...
                <div class="login-block">
                  ...
                  <asp:Label ID="lblError" runat="server" Text="" EnableTheming="false" ForeColor="Red"
                        ...
                        <div class="input-group emp-code">
                            ...
                            <label for="txtEmpCode" style="top: -10px; color: rgb(199, 193, 171);">Please enter OTP</label>
                        </div>
                   ...
                   <%--         <asp:TextBox ID="txtpassword" runat="server" autocomplete="off" style="width: 270px" TextMode="Password"   ></asp:TextBox>
                        ...
                        <div class="db-btn login-btn sub-btn" style="background-color:rgb(199, 193, 171)" runat="server"    >
                            <asp:Button ID="btnlogin"   runat="server" Text="Submit" BorderStyle="None" OnClick="btnlogin_Click" UseSubmitBehavior="false" />    
                                           
                        </div>
                        <div style="margin-top: 2px">
                        <span><asp:LinkButton ID="iresend" style="color: rgb(199, 193, 171)" runat="server" Text="Resend OTP" OnClick="iresend_Click" ></asp:LinkButton>  </span>
                            <span style="margin-left: 156px;"><asp:LinkButton ID="icancel" style="color: rgb(199, 193, 171)" runat="server" Text="Cancel" OnClick="icancel_Click"></asp:LinkButton></span>
                            </div>      
