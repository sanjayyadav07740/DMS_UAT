<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" AutoEventWireup="true" CodeBehind="RoleAccessRights.aspx.cs" Inherits="DMS.Role.RoleAccessRights" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphmain" runat="server">
    <center>
        <asp:Label ID="lblTitle" runat="server" Text="Role Access Rights" SkinID="Title"></asp:Label>
    </center>
    <table border="0" cellpadding="0" cellspacing="0" width="931">
        ...
        <tr>
            <td align="2" colspan="2">
                <asp:TreeView ID="tvwRoleAccessRights" ShowCheckBoxes="All" runat="server" EnableTheming="false"
                    ExpandDepth="1" Font-Underline="False"
                    Font-Names="Verdana"
                    Font-Size="8pt"
                    Font-Italic="False"
                    Font-Bold="False"
        ...
        <tr>
            ...
            <td align="left">
                <asp:ImageButton ID="ibtnCancel" runat="server" OnClick="ibtnCancel_Click" SkinID="CancelButton" /></td>
        </tr>
    </table>
</asp:Content>
