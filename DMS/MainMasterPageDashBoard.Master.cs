...
namespace DMS
{
    public partial class MainMasterPageDashBoard : System.Web.UI.MasterPage
    {
            ...
            if (!IsPostBack)
            {
                ...
                switch (objUtility.Result)
                {
                    ...
                    case Utility.ResultType.Failure:
                        DisplayMessage("No Data To Display .", MainMasterPageDashBoard.MessageType.Warning);
                        break;

                    case Utility.ResultType.Error:
                        DisplayMessage("Sorry ,Some Error Has Been Occured .", MainMasterPageDashBoard.MessageType.Error);
                        break;
