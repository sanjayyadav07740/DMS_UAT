<%@ Page Title="" Language="C#" MasterPageFile="~/MainMasterPage.Master" AutoEventWireup="true"
    CodeBehind="ViewForRejectedDocument.aspx.cs" Inherits="DMS.Shared.ViewForRejectedDocument" %>

<asp:Content ID="cphViewForRejectedDocumentHead" ContentPlaceHolderID="cphHead"
    runat="server">
</asp:Content>
<asp:Content ID="cphViewForRejectedDocumentMain" ContentPlaceHolderID="cphMain"
    runat="server">
  ...
  <table width="931" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td align="left" style="width:400px;">
                <uc:EntityModule ID="emodModule" runat="server" DisplayMetaDataCode="true" width="400"/>
            </td>
                ...
                <asp:GridView ID="gvwDocument" runat="server" AutoGenerateColumns="false" AllowSorting="true" Width="531"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MetaDataCode" HeaderText="MetaData Code" SortExpression="MetaDataCode"
                            NullDisplayText="N/A" />
                        <asp:BoundField DataField="Rejected Document Count" HeaderText="Rejected Document Count"
                            ControlStyle-Font-Bold="true" ControlStyle-ForeColor="Red" SortExpression="Rejected Document Count"
                            NullDisplayText="N/A" />
