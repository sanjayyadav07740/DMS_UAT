...
{
    public partial class ApprovedDocument : System.Web.UI.Page
    {
        ...
        protected void ibtnBack_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                if (ViewState["LASTPAGEURL"] != null)
                {
                    ...
                    else if (ViewState["LASTPAGEURL"].ToString().Contains("documentdashboardssl"))
                    {
                        Response.Redirect("../MetaData/DocumentDashBoard_SSL.aspx", false);
                    }
                }
