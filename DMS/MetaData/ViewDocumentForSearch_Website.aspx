<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewDocumentForSearch_Website.aspx.cs" Inherits="DMS.Shared.ViewDocumentForSearch_Website" %>
                    ...
                    <legend>View Document</legend>
                        ...
                        <tr>
                            <td align="center" style="z-index: -1;">
                                <cc1:ShowPdf ID="pdfViewer" runat="server" Height="550px" Width="1265px"
                                    Style="z-index: -1;" />
                            </td>
                        </tr>
                       <%-- <tr>
