...
{
    public partial class DocumentEntry_Virescent : System.Web.UI.Page
    {
        ...
        protected void ibtnSubmit_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //                objUtility.Result = objDocumentManager.SelectDocumentData_UP(objDocumentEntryExist);
            ...
            //                        MakerChecker_UP.DocumentGrid.DataSource = UserSession.Document;
            //                        MakerChecker_UP.DocumentGrid.DataBind();
            //                        return;
            //                        break;
            ...
            //            objUtility.Result = objDocumentManager.InsertDocumentEntry_UP(objDocumentEntry, objDbTransaction);
            //            switch (objUtility.Result)
            //            {
            ...
            //        objUtility.Result = objDocumentManager.UpdateDocument_UP(objDocument, objDbTransaction);
            //        switch (objUtility.Result)
            //        {
            //            case BusinessLogic.Utility.ResultType.Failure:
            //            case BusinessLogic.Utility.ResultType.Error:
            ...
            try
            {
                        ...
                        for (int i = 0; i < objDataTableCompletedEntry.Rows.Count; i++)
                        {
                            ...
                            switch (objUtility.Result)
                            {
                                case BusinessLogic.Utility.ResultType.Success:
                                    ...
                                    MakerChecker_Virescent.DocumentGrid.DataSource = UserSession.Document;
                                    MakerChecker_Virescent.DocumentGrid.DataBind();
                                    return;
                                    break;
                ...
                foreach (DataRow objDataRow in UserSession.Document.Select("IsCheck='1'"))
                {
                    ...
                    foreach (DataRow objDataRowNew in UserSession.Field.Rows)
                    {
                        objDocumentEntry.FieldID = Convert.ToInt32(objDataRowNew["ID"]);
                        objDocumentEntry.FieldData = objDataRow[objDataRowNew["ID"].ToString()].ToString();
                        objDocumentEntry.CreatedBy = UserSession.UserID;
